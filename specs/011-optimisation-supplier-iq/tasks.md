...
- [x] T010 [P] Write audit tests in `apps/api/tests/integration/test_supplier_iq_audit.py` for advanced basket submission, scorecard view, and anomaly dismissal audit events.
