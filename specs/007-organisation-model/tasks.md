...
- [x] T017 [P] [US1] Write branch-management E2E coverage in `apps/web/tests/e2e/organisation-branches.spec.ts`, proving create, edit, deactivate with a dependent cost centre, and Arabic RTL layout
...
- [x] T023 [P] [US2] Write frontend unit tests for the cost-centre list/form in `apps/web/src/app/features/settings/cost-centre-list/cost-centre-list.component.spec.ts`, covering create, duplicate-code error display, and orphaned-flag messaging
- [x] T024 [P] [US2] Write cost-centre-management E2E coverage in `apps/web/tests/e2e/organisation-cost-centres.spec.ts`, proving create with a budget owner and branch link, a duplicate-code rejection, and Arabic RTL layout
...
- [x] T027 [P] [US2] Build the cost-centre list/create/edit UI in `apps/web/src/app/features/settings/cost-centre-list/cost-centre-list.component.ts`, `.html`, and `.scss`, including a budget-owner picker sourced from the existing member list and an optional branch picker
...
- [x] T031 [P] [US3] Write budget-management E2E coverage in `apps/web/tests/e2e/organisation-budgets.spec.ts`, proving all three scopes and the overlap warning, plus Arabic RTL layout
...
- [x] T038 [P] [US4] Write branch-scoped-visibility E2E coverage in `apps/web/tests/e2e/organisation-branch-scoping.spec.ts`, proving a branch-scoped member's organisation screens show only their own branch's data and a guessed Branch B URL resolves as not found
...
- [x] T043 [P] Add organisation-settings accessibility coverage in `apps/web/tests/e2e/organisation-a11y.spec.ts`, scanning the settings screen in English and Arabic with zero axe-core WCAG 2.1 AA violations
