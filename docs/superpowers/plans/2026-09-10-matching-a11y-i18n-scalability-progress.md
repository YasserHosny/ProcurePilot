...
|---|---|---|---|
| Native candidate selection semantics | reviewed+committed | This commit | Antigravity refactored candidate cards to native radio-backed labels. Orchestrator added a DOM semantics assertion and updated the quality conclusion. |
| Match Resolution i18n/accessibility cleanup | queued | Pending | Next after native selection lands. |
