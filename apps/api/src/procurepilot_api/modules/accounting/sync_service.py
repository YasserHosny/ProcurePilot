        ...
        with conn.cursor(row_factory=dict_row) as cur:
            cur.execute(
                ...
                insert into synced_bill (
                    ...
                    %(currency)s,
                    %(due_date)s,
                    %(remaining_balance_amount)s,
                    %(remaining_balance_currency)s,
                    %(bill_date)s,
                    %(provider_status)s,
                ...
                set vendor_id = excluded.vendor_id,
                    ...
                    remaining_balance_amount = excluded.remaining_balance_amount,
                    remaining_balance_currency = excluded.remaining_balance_currency,
                ...
                """,
                {
                    ...
                    "due_date": raw_bill.due_date,
                    "remaining_balance_amount": raw_bill.remaining_balance,
                    "remaining_balance_currency": (
                        raw_bill.currency if raw_bill.remaining_balance is not None else None
                    ),
