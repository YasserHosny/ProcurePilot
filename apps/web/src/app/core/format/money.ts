/**
 * Re-exported from packages/domain-types/src/money.ts.
 *
 * The package is the canonical home (it is shared with mobile in Phase 2); this copy exists
 * because the Angular build does not yet resolve the workspace package. When the monorepo's
 * TypeScript paths are wired up, delete this file and import from @procurepilot/domain-types.
 *
